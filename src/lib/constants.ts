...
> = {
  ...
  PICKUP_SCHEDULED: {
    ...
    description: 'Agent scheduled for pickup window',
    stepIndex: 1,
    color: 'text-blue-600',
    badgeVariant: 'blue',
  },
  ...
  PROCESSING: {
    ...
    description: 'Garments undergoing facility care',
    stepIndex: 5,
    color: 'text-purple-600',
    badgeVariant: 'blue',
  },
  ...
  IRONING: {
    ...
    description: 'Crisp steam ironing in progress',
    stepIndex: 8,
    color: 'text-amber-600',
    badgeVariant: 'amber',
  },
  FOLDING: {
    label: 'Precision Folding',
    description: 'Precision folded and eco-packaged',
    stepIndex: 8,
    color: 'text-amber-600',
    badgeVariant: 'amber',
  },
  ...
  REFUND_PENDING: {
    ...
    description: 'Refund requested and under review',
    stepIndex: -1,
    color: 'text-amber-600',
    badgeVariant: 'amber',
  },
